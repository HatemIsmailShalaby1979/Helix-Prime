...
1. C3 — Security/Privacy & Observability (parallel with C2, depends C1) ← **next frontier**
2. C4 — Six-Engine Productization (depends C2 + C3 seam)
3. C5 — Contact-Centre Vertical Slice Proof (depends C4)
4. C6 — GM Expansion (Compliance,Fraud,HR,L&D,Sales,Marketing,ICT) (depends C5)
5. C7 — Sibling-Project Integration (depends C1; implement after C5 contracts)
6. C8 — Production Candidate & Controlled Pilot Pack (depends C5)
