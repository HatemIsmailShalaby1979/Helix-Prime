...
def build_synthetic_restaurant(tenant_id: str, client_id: str, as_of: str) -> dict:
    ...
    shifts = [
        ...
        Shift(
            ...
            "dinner",
            4,
            ("emp-cook-1", "emp-server-1", "emp-host-1"),
            tenant_id,
            client_id,
    ...
    inventory = [
        InventoryItem(
            ...
            tenant_id,
            client_id,
            _src("Inventory", "inv-lettuce", as_of),
        ),
        InventoryItem(
            "inv-flour",
            "Flour",
            ...
            tenant_id,
            client_id,
            _src("Inventory", "inv-flour", as_of),
        ),
        InventoryItem(
            "inv-cheese",
            "Cheese",
            ...
            tenant_id,
            client_id,
            _src("Inventory", "inv-cheese", as_of),
        ),
    ]
