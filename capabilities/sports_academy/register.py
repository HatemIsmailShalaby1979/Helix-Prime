...
def get_academy_metadata() -> dict:
    return {
        ...
        "ontology": ["Athlete", "Family", "Coach", "Program", "Session",
                     "CheckIn", "FacilitySlot", "FeePayment", "EnrollmentRecord"],
        "roles": list(ROLES),
        ...
        "metrics": [
            "attendance_rate", "churn_rate", "facility_utilization", "mrr",
            "active_athletes", "session_adherence",
            "athlete_attendance_rate", "session_delivery_ontime",
            "parent_satisfaction",
        ],
        "connector_contracts": {
            "provider": "AcademyOps",
            ...
            "reads": ["athletes", "families", "coaches", "programs", "sessions",
                      "checkins", "facility_slots", "fee_payments",
                      "enrollment_records"],
            "writes": [],
        ...
        "reused_core": [
            ...
            "pilot.consent", "metacognition.improvement",
            "engines.rta.adapter", "engines.cx.adapter",
