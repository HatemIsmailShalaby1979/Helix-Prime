...
> This MAP file documents the original B2B Onboarding engine file listing from the old `AI Automation Engineering\04_helix_mini\` structure, before the engine directories were lost during the rename/merge operation and subsequently recovered to `engines/b2b/`. For the current engine structure, see `docs/ENGINEERING_SPECIFICATION.md` §1.3 or `ROOT_BOOT.md`.
