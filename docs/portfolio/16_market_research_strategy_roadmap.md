...
[`01_architecture_overview.md`](01_architecture_overview.md) and the 445-test baseline in
...
- The 15-document portfolio (445 tests, `governance=PASS`, security `all_ok=True`, published
