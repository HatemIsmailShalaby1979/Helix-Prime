...
2. Build the attendance adapter (simplest first value)
3. Conduct discovery meeting using the 7 questions in section 6.2
4. Do NOT pitch the product until after discovery
