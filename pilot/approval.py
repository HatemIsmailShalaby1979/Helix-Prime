    ...
    *,
    ...
    return mem.add(
        ...
        provenance={
            "correlation_id": correlation_id,
            "data_mode": data_mode,
            "basis": "approval_request",
            "sources": [recommendation_id],
        },
        body={
            "action": action,
...
def transition_approval(
    ...
    return mem.add(
        ...
        actor=actor,
        role_id=role_id,
        source="pilot_approval_transition",
        classification="client_confidential",
        timestamp=timestamp,
        correlation_id=correlation_id,
        confidence=1.0,
        evidence_refs=list(prev.evidence_refs),
        data_mode=prev.data_mode,
        provenance={
            "correlation_id": correlation_id,
            "data_mode": prev.data_mode,
            "basis": "approval_transition",
...
def evaluate_approval_decision(
    prev, decision: str, approver_actor, approver_role, requester_actor, requester_role
) -> tuple[bool, str]:
